...
import { api, ApiError, type ApiFileEntry, type ApiServer } from '../lib/api';
...
/** Modal file manager for one server: browse, edit, upload and delete. */
export default function FilesDialog({ server, onClose }: FilesDialogProps) {
          ...
          <>
            <div className="flex items-center justify-between gap-3 border-b border-peregrine-800 px-5 py-3">
              <div className="min-w-0">
                ...
                <p className="truncate font-mono text-xs text-peregrine-400">
                  {currentPath}
                </p>
              </div>
